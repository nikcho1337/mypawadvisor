            ...
            {[
              {
                ...
                img: "https://images.unsplash.com/photo-1633722715463-d30f4f325e24?w=600&q=80",
              ...
              >
                <div className="relative h-40 overflow-hidden bg-gray-100">
                  ...
                  <img
                    src={post.img}
                    alt={post.imgAlt}
                    className={`w-full h-full object-cover group-hover:scale-105 transition-transform duration-500 ${post.imgAlt === "Golden Retriever dog" ? "object-top" : "object-center"}`}
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/25 to-transparent" />
